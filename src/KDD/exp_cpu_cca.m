...
for iii=1:length(ds),
 ...
 min(his1)
    ...
    plot(tt1,his1,'-','LineWidth',5,'MarkerSize',22,'color', pcolor.crimson3 ); hold on;
    plot(tt2,his2,'-','LineWidth',5,'MarkerSize',22,'color',  pcolor.blue ); hold on;
    plot(tt3,his3,'-','LineWidth',5,'MarkerSize',22,'color', pcolor.gray); hold on;
    plot(tt4,his4,'-','LineWidth',5,'MarkerSize',22,'color', pcolor.darkred); hold on;
    plot(tt5,his5,'-','LineWidth',5,'MarkerSize',22,'color', pcolor.yellow); hold on;
    plot(tt6,his6,'-','LineWidth',5,'MarkerSize',22,'color', pcolor.purple); hold on;
    plot(tt7,his7,'-','LineWidth',5,'MarkerSize',22,'color', pcolor.orange3); hold on;
    plot(tt8,his8,'-','LineWidth',5,'MarkerSize',22,'color', pcolor.green); hold on;
